...
//this file creates the tables defined by models, and loops over the songs json object which was parsed into a JS object, to then create songs.

const fs = require('fs');
const { db, Album, Artist, Song } = require('../server/db'); //requires index.js file by default
